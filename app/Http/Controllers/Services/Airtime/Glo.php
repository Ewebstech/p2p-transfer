<?php
namespace App\Http\Controllers\Services\Airtime;
...
class Glo 
{
    ...
    public static function purchaseAirtime($transactionData){
        self::prepareParams();
        ...
        try{
            ...
            if(self::$provider == "MobileNig"){
                ...
                if(self::$env == "test"){
                    $requestString = self::$apiUrl . "/airtime_premium_test?username=".self::$apiUsername."&api_key=".self::$apiKey."&network=".$transactionData['service']."&phoneNumber=".$transactionData['phonenumber']."&amount=".$transactionData['amount']."&trans_id=".$transactionData['reference']."&return_url=".self::$returnUrl;
                } else {
                    $requestString = self::$apiUrl . "/airtime_premium?username=".self::$apiUsername."&api_key=".self::$apiKey."&network=".$transactionData['service']."&phoneNumber=".$transactionData['phonenumber']."&amount=".$transactionData['amount']."&trans_id=".$transactionData['reference']."&return_url=".self::$returnUrl;
                }
