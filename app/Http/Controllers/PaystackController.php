...
class PaystackController extends Controller
{
    ...
    public function redirectToProvider($params)
    {
        ...
        try {
            ...
            Log::info(
                'Redirecting Payment Request to Paystack: ' .
            ...
            Log::error(
                'An error occured while making request to Paystack: ' .
                    $e->getMessage()
            );
            return false;
        }
    ...
    public function handleGatewayCallback(Request $request)
    {
        ...
        if ($response->status === true) {
            ...
            $alreadyCredited = TransactionsController::findDuplicateTransactions(
            ...
            if ($alreadyCredited === false) {
                ...
                WalletController::creditWallet(
                    $params['amountToCredit'],
                    $params['metadata']['walletID']
                );
            }
            ...
            return 'Wallet Funding of N' .
                number_format($params['amountToCredit']) .
                ' is Successful.';
        } else {
            $params['error'] = true;
            ...
            return 'Wallet Funding of N' .
                number_format($params['data']['amount']) .
                ' Failed.';
        }
    }
    ...
    {
        \Log::info(
            'Send Authorization Check Request for ' . json_encode($params)
        );
        $checkAuthUrl =
