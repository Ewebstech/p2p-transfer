...
<div class="w3layouts-breadcrumbs text-center">
    <div class="container">
      <span class="agile-breadcrumbs"><a href="/dashboard"><i class="fa fa-home home_1"></i> Dashboard</a> / <span><a href="/admin/manual-funding">Manual Funding</a></span> / <span>Funding History</span></span>
    </div>
</div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="bg-light shadow-md rounded p-4" style="padding: 30px !important;"> 
          <!-- Orders History
          ============================================= -->
          <h4 class="mb-3">ALL Manual Funding History</h4>
                ...
                <table id="example" class="table table-hover table-responsive" style="width:100%;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left !important;">{{ $transaction['remark'] ?? 0 }} </td>
